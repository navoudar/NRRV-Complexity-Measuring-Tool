...
<meta charset="utf-8">
  ...
  <!-- Bootstrap core CSS -->
    ...
    <title>Weight related to the coupling factor </title>
        ...
        <div class="col-md-9">
            <!-- Website Overview -->
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Weights related to the coupling factor </h3>
              </div>
...
<table style="width:80%">
  ...
  <tr> 
  <td> A regular method calling a recursive method in the different file </td>
  ...
  <tr> 
  <td> A recursive method calling another recursive method in the different file </td>
  ...
  <tr> 
  <td> A recursive method calling a regular method in the different file </td>
