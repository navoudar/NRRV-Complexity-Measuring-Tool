...
<meta charset="utf-8">
  ...
  <!-- Bootstrap core CSS -->
    ...
    <title>Weight related to the inheritance factor </title>
        ...
        <div class="col-md-9">
            <!-- Website Overview -->
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Weights related to the inheritance factor </h3>
              </div>
...
<table style="width:80%">
  ...
  <td> A class with no inheritance (direct or indirect) </td>
   ...
   <tr>
  <td> A class inheriting (directly or indirectly) from <b>one</b> user-defined class </td>
  ...
  <tr> 
  <td> A class inheriting (directly or indirectly) from <b>two</b> user-defined class </td>
  ...
  <tr> 
  <td> A class inheriting (directly or indirectly) from <b>three</b> user-defined class </td>
  ...
  <tr> 
  <td> A class inheriting (directly or indirectly) from <b>more than three</b> user-defined class </td>
